...
TEST(move, test1) {
  my::Queue<int> st_1({1, 2, 3});
  my::Queue<int> st_2(std::move(st_1));
...
TEST(oper_move, test1) {
  my::Queue<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::queue<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  my::Queue<double> st_copy;
