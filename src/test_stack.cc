...
TEST(my_stack_push_top_check, test1) {
  my::Stack<int> st;
...
TEST(my_stack_push_top_check, test2) {
  my::Stack<char> st;
...
TEST(my_stack_size_check, test1) {
  my::Stack<int> st;
  std::stack<int> st_original;
...
TEST(my_stack_size_check, test2) {
  my::Stack<char> st;
  std::stack<char> st_original;
  ASSERT_EQ(st.size(), st_original.size());
...
TEST(my_stack_empty_check, test1) {
  my::Stack<int> st;
  std::stack<int> st_original;
...
TEST(my_stack_empty_check, test2) {
  my::Stack<char> st;
  std::stack<char> st_original;
  ASSERT_EQ(st.empty(), st_original.empty());
...
TEST(my_stack_initializer_check, test1) {
  my::Stack<int> st({11, 22, 33, 44, 88});
...
TEST(my_stack_initializer_check, test2) {
  my::Stack<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
...
TEST(my_stack_copy_check, test1) {
  my::Stack<int> st_1;
...
TEST(my_stack_copy_check, test2) {
  my::Stack<int> st_1({7, 8, 9});
...
TEST(my_stack_copy_check, test3) {
  my::Stack<char> st_1({'a', 'b', 'c'});
  std::stack<char> st_original_1({'a', 'b', 'c'});
  std::stack<char> st_original_2(st_original_1);
  my::Stack<char> st_2(st_1);
...
TEST(my_stack_copy_oper_check, test1) {
  my::Stack<int> st_1;
  std::stack<int> st_original_1;
  st_1.push(5);
  st_original_1.push(5);
...
TEST(my_stack_copy_oper_check, test2) {
  my::Stack<int> st_1;
  std::stack<int> st_original_1;
  st_1.push(5);
  st_original_1.push(5);
...
TEST(my_stack_copy_oper_check, test3) {
  my::Stack<char> st_1({'a', 'b', 'c'});
  std::stack<char> st_original_1({'a', 'b', 'c'});
...
TEST(my_stack_copy_oper_check, test4) {
  my::Stack<char> st_1({'a', 'b', 'c'});
  std::stack<char> st_original_1({'a', 'b', 'c'});
...
TEST(my_stack_move_check, test1) {
  my::Stack<int> st_1({1, 2, 3});
  my::Stack<int> st_2(std::move(st_1));
...
TEST(my_stack_move_oper_check, test1) {
  my::Stack<int> st_1({1, 2, 3});
  my::Stack<int> st_2;
  st_2 = (std::move(st_1));
  std::stack<int> st_original_1({1, 2, 3});
...
TEST(my_stack_move_oper_check, test2) {
  my::Stack<int> st_1({1, 2, 3});
  my::Stack<int> st_2;
  st_2 = (std::move(st_1));
  std::stack<int> st_original_1({1, 2, 3});
...
TEST(my_stack_swap, test1) {
  my::Stack<int> st_1({11, 22, 33, 44, 88});
  my::Stack<int> st_2({55, 66, 77, 99, 0});
...
TEST(my_stack_swap, test2) {
  my::Stack<std::string> st_1({"aa", "bb", "cc"});
  my::Stack<std::string> st_2({"aboba"});
