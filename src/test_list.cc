...
TEST(my_list_create_n_check, test1) {
  my::List<char> st(3);
...
TEST(my_list_create_n_check, test2) {
  my::List<int> st(3);
...
TEST(my_list_create_n_check, test3) {
  my::List<double> st(3);
...
TEST(my_list_initializer_check, test1) {
  my::List<int> st({11, 22, 33, 44, 88});
...
TEST(my_list_initializer_check, test2) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
...
TEST(my_list_constr_copy_check, test1) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::list<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  my::List<double> st_copy = st;
...
TEST(my_list_oper_copy_check, test1) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::list<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  my::List<double> st_copy;
...
TEST(my_list_constr_move_check, test1) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::list<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  my::List<double> st_copy(std::move(st));
...
TEST(my_list_oper_move_check, test1) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::list<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  my::List<double> st_copy;
  std::list<double> st_original_copy;
...
TEST(my_list_reverse_check, test1) {
  my::List<char> st;
  std::list<char> st_original;
  st.push_front('a');
  st_original.push_front('a');
...
TEST(my_list_reverse_check, test2) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ...
  my::List<int>::iterator it = st.begin();
...
TEST(my_list_reverse_check, test3) {
  my::List<int> st({1});
...
TEST(my_list_erase_check, test1) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_erase_check, test2) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
  ...
  my::List<int>::iterator it = st.end();
...
TEST(my_list_erase_check, test3) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_erase_check, test4) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_erase_check, test5) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_erase_check, test6) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_erase_check, test7) {
  my::List<int> st({81});
...
TEST(my_list_erase_check, test8) {
  my::List<int> st({22});
...
TEST(my_list_bool_check, test1) {
  my::List<int> st({1, 2, 3, 4, 5, 6, 7, 8, 9});
  std::list<int> st_original({1, 2, 3, 4, 5, 6, 7, 8, 9});

  my::List<int>::iterator it_1 = st.end();
  std::list<int>::iterator it_original_1 = st_original.end();
  --it_1;
  --it_original_1;

  my::List<int>::iterator it_2 = st.end();
...
TEST(my_list_bool_check, test2) {
  ...
  --it_1;
  --it_original_1;
  my::List<int>::iterator it_2 = it_1;
...
TEST(my_list_begin_check, test1) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_end_check, test1) {
  ...
  my::List<double>::iterator it = st.end();
...
TEST(my_list_it_check, test1) {
  ...
  my::List<char>::iterator it = st.begin();
...
TEST(my_list_insert_check, test1) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test2) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test3) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test4) {
  my::List<char> st({'a', 'b', 'c', 'd'});
  std::list<char> st_original({'a', 'b', 'c', 'd'});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
  ASSERT_EQ(st.size(), st_original.size());

  my::List<char>::iterator it = st.end();
...
TEST(my_list_insert_check, test5) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test6) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test7) {
  my::List<int> st;
  st.push_back(1);
  st.push_back(2);
  st.push_back(3);
...
TEST(my_list_insert_check, test8) {
  my::List<char> st({'a', 'b', 'c', 'd'});
  std::list<char> st_original({'a', 'b', 'c', 'd'});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_insert_check, test9) {
  my::List<char> st({'a'});
...
TEST(my_list_insert_check, test10) {
  my::List<char> st({'a'});
  std::list<char> st_original({'a'});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_insert_check, test11) {
  my::List<char> st({'a'});
  std::list<char> st_original({'a'});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_insert_check, test12) {
  my::List<int> st;
  std::list<int> st_original;
  ASSERT_EQ(st.size(), st_original.size());
...
TEST(my_list_insert_check, test13) {
  my::List<char> st;
  std::list<char> st_original;
  ASSERT_EQ(st.size(), st_original.size());
...
TEST(my_list_insert_check, test14) {
  my::List<int> st;
  std::list<int> st_original;
  ASSERT_EQ(st.size(), st_original.size());
...
TEST(my_list_insert_check, test15) {
  my::List<char> st({'a'});
  std::list<char> st_original({'a'});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_insert_check, test16) {
  my::List<int> st({1, 1, 2, 3, 3, 3, 4});
...
TEST(my_list_swap_check, test1) {
  my::List<int> st_1({1, 2, 3, 4, 5});
  my::List<int> st_2({6, 7, 8, 9, 0, 10, 11});
  ...
  my::List<int>::iterator it = st_1.begin();
...
TEST(my_list_swap_check, test2) {
  my::List<int> st_2({1, 2, 3, 4, 5});
  my::List<int> st_1({6, 7, 8, 9, 0, 10, 11});
  ...
  my::List<int>::iterator it = st_1.end();
...
TEST(my_list_splice_check, test1) {
  my::List<int> st_1({1, 2, 3, 4, 5});
  my::List<int> st_2({6, 7, 8, 9, 0, 10, 11});
  std::list<int> st_original_1({1, 2, 3, 4, 5});
  std::list<int> st_original_2({6, 7, 8, 9, 0, 10, 11});
...
TEST(my_list_splice_check, test2) {
  my::List<int> st_1({1, 2, 3, 4, 5});
  my::List<int> st_2({6, 7, 8, 9, 0, 10, 11});
  std::list<int> st_original_1({1, 2, 3, 4, 5});
  std::list<int> st_original_2({6, 7, 8, 9, 0, 10, 11});
...
TEST(my_list_splice_check, test3) {
  my::List<int> st_1;
  my::List<int> st_2({6, 7, 8, 9, 0, 10, 11});
...
TEST(my_list_splice_check, test4) {
  my::List<int> st_1({1, 2, 3, 4, 5});
  my::List<int> st_2;
  std::list<int> st_original_1({1, 2, 3, 4, 5});
...
TEST(my_list_unique_check, test1) {
  my::List<char> st({'b', 'b', 'b', 'd'});
...
TEST(my_list_unique_check, test2) {
  my::List<int> st({1, 1, 2, 3, 4});
...
TEST(my_list_unique_check, test3) {
  my::List<int> st({1, 1, 2, 3, 3, 3, 4});
  std::list<int> st_original({1, 1, 2, 3, 3, 3, 4});
  ASSERT_EQ(st.front(), st_original.front());
  ASSERT_EQ(st.back(), st_original.back());
...
TEST(my_list_unique_check, test4) {
  my::List<int> st({1, 2, 4, 4});
...
TEST(my_list_unique_check, test5) {
  my::List<int> st({1, 2, 1, 2});
...
TEST(my_list_sort_check, test1) {
  my::List<int> st({7, 3, 4, 2, 6, 9, 11, 1});
...
TEST(my_list_sort_check, test3) {
  my::List<double> st({-25.7, -334.2, 0., 329.715, 7100000.25, -955538.336,
                        -0.55555555587, 799});
  ...
  ASSERT_EQ(st.back(), st_original.back());
  ASSERT_EQ(st.size(), st_original.size());
  my::List<double>::iterator it = st.begin();
...
TEST(my_list_merge_check, test1) {
  my::List<int> st_1({1, 3, 4, 6, 8, 11, 14, 22});
  my::List<int> st_2({2, 5, 7, 9, 16, 17, 24, 25});
...
TEST(my_list_merge_check, test2) {
  my::List<int> st_1({1});
  my::List<int> st_2({2, 5, 7, 9, 16, 17, 24, 25});
...
TEST(my_list_merge_check, test3) {
  my::List<int> st_1({151});
  my::List<int> st_2({2, 5, 7, 9, 16, 17, 24, 25});
...
TEST(my_list_max_size_check, test1) {
  my::List<double> st({11.11, 22.22, 33.33, 44.44, 88.88});
  std::list<double> st_original({11.11, 22.22, 33.33, 44.44, 88.88});
  ASSERT_EQ(st.max_size(), st_original.max_size());
}

TEST(my_list_max_size_check, test2) {
  my::List<long long int> st;
