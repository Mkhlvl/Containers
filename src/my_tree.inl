...
template <typename key_type, typename mapped_type>
std::pair<typename my::BinaryTree<key_type, mapped_type>::Iterator, bool>
my::BinaryTree<key_type, mapped_type>::insert(const value_type& value) {
...
template <typename key_type, typename mapped_type>
std::pair<typename my::BinaryTree<key_type, mapped_type>::Iterator, bool>
my::BinaryTree<key_type, mapped_type>::insert(const key_type& key,
...
template <typename key_type, typename mapped_type>
std::pair<typename my::BinaryTree<key_type, mapped_type>::Iterator, bool>
my::BinaryTree<key_type, mapped_type>::insert_or_assign(
